...
def scrape():
    ...
    remaining = soup.find_all(class_="parts__NumberToAnimate-sc-8607a6e4-0 jeWUmb")[0].get_text()
    sold = soup.find_all(class_="parts__NumberToAnimate-sc-8607a6e4-0 jeWUmb")[3].get_text()
